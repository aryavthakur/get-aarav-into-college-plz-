...
class TestClaimExtraction:
    ...
    @pytest.mark.parametrize("phrase", [
        ...
        "The company announced a strategic restructuring of its oncology program.",
        "The company announced a strategic restructuring affecting its lead clinical asset.",
    ])
    ...
    @pytest.mark.parametrize("phrase", [
        ...
        "The company announced a strategic restructuring of corporate operations.",
    ])
